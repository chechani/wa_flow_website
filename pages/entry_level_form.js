...
export default function Entry_Level_Form() {
    ...
    useEffect(() => {
        ...
        const { customer_name, email, mobile_number, password, confirm_password } = EntryFormData;
    ...
    const handleChange = (e) => {
        ...
        if (name === "confirm_password" && value !== EntryFormData.password) {
    ...
    const handlePayNowClick = () => {
        ...
        if (window.Razorpay) {
            ...
            const options = {
                ...
                amount: 900000, // Example: 50000 represents Rs. 500.00
                currency: 'INR',
                ...
                handler: async function (response) {
                    if (response) {
                        const response = await axios.post('https://foss-erp.in/api/method/smarty_web.ai_wa_bot.create_customer', EntryFormData);
                        if (response.data.status_code === 200) {
                            setApi_message(response.data.message);
                            setIsAccountVerified(true);
                        } else {
                ...
                prefill: {
                    name: EntryFormData.customer_name,
                    email: EntryFormData.email,
                    contact: EntryFormData.mobile_number
                }
            };
                        ...
                        <div className="col-xl-6 col-lg-6 col-md-12 pd_left_60 md_pd_left_15">
                            <div className="title_all_box style_one text-left dark_color">
                                <div className="title_sections">
                                    <div className="title">Entry Pricing : Unlock Features</div>
                                </div>
                                <div>
                                    <p>
                                        An
                                        ...
                                        Access top-tier bot solutions tailored to your business needs.
                                    </p>
                                </div>
                            </div>
                                                    ...
                                                    <div className="text-center">
                                                        {successMessage ? (
                                                            ...
                                                            <>
                                                                ...
                                                                <h2 className="mt-5"
                                                                    style={{ fontWeight: "bold" }}>{Api_message}</h2>
                                                                <button
                                                                ...
                                                                <div className="row">
                                                                    <p>
                                                                        <label style={{ textAlign: "center", fontSize: 20 }}>Enter Otp
                                                                            <br />
                                                                            <span className="wpcf7-form-control-wrap your-number mt-4">
                                                                                <input
                                                                                    type="text"
                                                                                    name="otp"
                                                                                    size={10}
                                                                    ...
                                                                    <label> Customer Name
                                                                        ...
                                                                        <span
                                                                            ...
                                                                            <input type="text" name="customer_name" required size={20}
                                                                                ...
                                                                                value={EntryFormData.customer_name}
                                                                ...
                                                                <p><label>Mobile Number<br />
                                                                    <span className="wpcf7-form-control-wrap your-number">
                                                                        <input type="tel"
                                                                            ...
                                                                            value={EntryFormData.mobile_number}
                                                                            onChange={handleChange} />
                                                                    </span>
                                                                    <br />
                                                                    ...
                                                                    <label>Confirm Password<br />
                                                                        <span
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                value={EntryFormData.confirm_password}
                                                                ...
                                                                {/* <p style={{ marginTop: 10 }}>
                                                                    <label>
                                                                        <span> <input type='checkbox'
                                                                            onChange={(e) => setEntryFormData({ ...EntryFormData, terms_and_condition: e.target.checked })}
                                                                            style={{ width: 15 }} /></span>
