...
export default function Growth_Level_Form() {
    ...
    useEffect(() => {
        ...
        const { customer_name, email, mobile_number, password, confirm_password } = GrowthFormData;
    ...
    const handleChange = (e) => {
        ...
        if (name === "confirm_password" && value !== GrowthFormData.password) {
    ...
    const handlePayNowClick = () => {
        ...
        if (window.Razorpay) {
            ...
            const options = {
                ...
                amount: 1500000, // Example: 50000 represents Rs. 500.00
                currency: 'INR',
                ...
                handler: async function (response) {
                    if (response) {
                        const response = await axios.post('https://foss-erp.in/api/method/smarty_web.ai_wa_bot.create_customer', GrowthFormData);
                        if (response.data.status_code === 200) {
                            setApi_message(response.data.message);
                            setIsAccountVerified(true);
                        } else {
                ...
                prefill: {
                    name: GrowthFormData.customer_name,
                    email: GrowthFormData.email,
                    contact: GrowthFormData.mobile_number
                }
            };
                        ...
                        <div className="col-xl-6 col-lg-6 col-md-12 pd_left_60 md_pd_left_15">
                            <div className="title_all_box style_one text-left dark_color">
                                <div className="title_sections">
                                    <div className="title">Growth Pricing : Unlock Advance Features</div>
                                </div>
                                <div>
                                    <p>
                                        <p>An <strong>OTP</strong> sent to your registered <strong>mail Id</strong>. Access advance top-tier bot solutions tailored to your business needs.</p>
                                    </p>
                                </div>
                            </div>
                                                    ...
                                                    <div className="text-center">
                                                        {successMessage ? (
                                                            <>
                                                                ...
                                                                <h2 className="mt-5" style={{ fontWeight: "bold" }}>{Api_message}</h2>
                                                                <button
                                                                    className="btn btn-secondary mt-5"
                                                                    style={{ width: 100 }}
                                                                    onClick={handleClosePage}>Close</button>
                                                            </>
                                                        ) : (
                                                            <>
                                                    ...
                                                    <div className="_form">
                                                        {submitted ? (
                                                            <form
                                                                ...
                                                                <div className="row">
                                                                    <p>
                                                                        <label style={{ textAlign: "center", fontSize: 20 }}>Enter Otp
                                                                            <br />
                                                                            <span
                                                                ...
                                                                <p><label> Customer Name<br />
                                                                    <span className="wpcf7-form-control-wrap your-name">
                                                                        <input type="text" name="customer_name" required size={20}
                                                                            ...
                                                                            value={GrowthFormData.customer_name}
                                                                ...
                                                                <p><label>Mobile Number<br />
                                                                    <span className="wpcf7-form-control-wrap your-number">
                                                                        <input type="tel"
                                                                            ...
                                                                            value={GrowthFormData.mobile_number}
                                                                            onChange={handleChange} />
                                                                    </span>
                                                                    <br />
                                                                    ...
                                                                    <label>Confirm Password<br />
                                                                        <span
                                                                            ...
                                                                            <input
                                                                                ...
                                                                                value={GrowthFormData.confirm_password}
                                                                ...
                                                                {/* <p style={{ marginTop: 10 }}>
                                                                    <label>
                                                                        <span> <input type='checkbox'
                                                                            onChange={(e) => setGrowthFormData({ ...GrowthFormData, terms_and_condition: e.target.checked })}
                                                                            style={{ width: 15 }} /></span>
