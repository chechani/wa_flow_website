...
export default function Breadcrumb4({ breadcrumbTitle4, blogMetaSingle }) {
    return (
        <>
            <div className={`page_header_default style_one ${blogMetaSingle ? "blog_single_pageheader" : ""}`}>
                <div className="parallax_cover">
                    <div className="simpleParallax"><img src="/assets/images/contact_us.jpg" alt="bg_image" className="cover-parallax" /></div>
                </div>
                            ...
                            <div className="col-lg-12">
                                <div className="breadcrumbs creote">
                                    <ul className="breadcrumb m-auto">
                                        ...
                                        <li className="active">{breadcrumbTitle4}</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
