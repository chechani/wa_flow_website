...
export default function Breadcrumb2({ breadcrumbTitle2, blogMetaSingle }) {
    return (
        <>
            <div className={`page_header_default style_one ${blogMetaSingle ? "blog_single_pageheader" : ""}`}>
                <div className="parallax_cover">
                    <div className="simpleParallax"><img src="/assets/images/T&C.jpg" alt="bg_image" className="cover-parallax" /></div>
                </div>
