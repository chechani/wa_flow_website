...
import MauticTracking from "@/pages/MauticTracking"
// import StyleSwitcher from './StyleSwitcher'

export default function Layout({ headerStyle, footerStyle, breadcrumbTitle,breadcrumbTitle1,breadcrumbTitle2,breadcrumbTitle3,breadcrumbTitle4, children, blogMetaSingle }) {
    // Search
        ...
        <>
            <div id="page" className={`page_wapper hfeed site ${scroll ? "fixed-header floating-menu" : ""} ${isMobileMenu ? "crt_mobile_menu-visible" : ""} ${isCart ? "side_bar_cart-visible" : ""}`}>
                ...
                <div id="wrapper_full" className="content_all_warpper">
                    ...
                    {breadcrumbTitle1 && <Breadcrumb1 breadcrumbTitle1={breadcrumbTitle1} blogMetaSingle={blogMetaSingle}/>}
                    {breadcrumbTitle2 && <Breadcrumb2 breadcrumbTitle2={breadcrumbTitle2} blogMetaSingle={blogMetaSingle}/>}
                    {breadcrumbTitle3 && <Breadcrumb3 breadcrumbTitle3={breadcrumbTitle3} blogMetaSingle={blogMetaSingle}/>}
                    {breadcrumbTitle4 && <Breadcrumb4 breadcrumbTitle4={breadcrumbTitle4} blogMetaSingle={blogMetaSingle}/>}
