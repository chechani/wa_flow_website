        ...
        <>
            ...
            <section className="project-section bg_light_1 position-relative">
                ...
                <div style={{ textAlign: "center" }}>
                    <h6 style={{ fontWeight: "600", fontSize: "40px" }}>Let's Get Started On Something Great</h6>
                    <br />
                    <p style={{ fontWeight: "500", fontSize: "20px" }}>Already more than 1000+ people working with us. Are you next?</p>
               
                <div className="thm_btn mt-5">
